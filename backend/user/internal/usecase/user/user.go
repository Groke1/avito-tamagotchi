...
func (s *userService) Register(ctx context.Context, user entity.User) (*entity.JWT, error) {
...
func (s *userService) Login(ctx context.Context, email, password string) (*entity.JWT, error) {
...
func (s *userService) Refresh(ctx context.Context, refreshToken string) (*entity.JWT, error) {
