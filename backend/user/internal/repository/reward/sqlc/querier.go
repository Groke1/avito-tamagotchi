...
type Querier interface {
	...
	GetRewardDefinitionByCode(ctx context.Context, code string) (GetRewardDefinitionByCodeRow, error)
	GetRewardDefinitions(ctx context.Context) ([]GetRewardDefinitionsRow, error)
